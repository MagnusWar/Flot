...
with st.sidebar:
    ...
    ironcon = st.slider(
        label='% Concentraado de hierro (%Fe)',
        min_value=60,
        max_value=70,
        value=65,
        step=1
...
**Esta herramienta ayuda a los ingenieros y operadores de plantas de concentración de minerales a:**
...
with st.expander("ℹ️ Sobre la Aplicación"):
    ...
    **¿Cómo funciona?**
    ...
    3.  **Resultado:** La aplicación muestra el rendimiento final predicho como un porcentaje de concentrado de sílica.

    **Detalles del Modelo:**

    * **Tipo de Modelo:** `Regression Model` (XGBoost Optimizado)
    * **Propósito:** Predecir el valor continuo del rendimiento del concentrado de sílica.
    * **Características Usadas:** Flujo de amina, Flujo de aire en la columna de flotación 3 y Porcentaje de concentrado de hierro.
    """)
